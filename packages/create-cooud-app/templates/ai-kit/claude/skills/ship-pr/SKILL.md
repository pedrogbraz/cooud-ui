...
- Run the `code-review` skill first if it hasn't been run. Nothing P0/P1 ships below the
  95% confidence gate (see `AGENTS.md`).
...
`type` ∈ `feat | fix | chore | docs | refactor | test | perf`. Keep the subject short.
