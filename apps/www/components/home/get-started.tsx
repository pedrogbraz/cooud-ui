...
function CommandBlock({ command }: { command: string }) {
  ...
  return (
    <div className="relative flex items-center gap-2 rounded-xl border border-border bg-surface-inset px-4 py-3 pr-12 font-mono text-sm">
...
/** One of the two "get started" paths: an icon, copy, and a copyable command. */
function PathCard({ icon, title, description, command }: PathCardProps) {
  return (
    <div className="flex flex-col gap-5 rounded-2xl border border-border bg-surface-raised p-6 shadow-xs">
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-2xl text-fg-secondary">
              Scaffold a fresh, themed app, or drop components into the app you already have.
            </p>
          </div>
